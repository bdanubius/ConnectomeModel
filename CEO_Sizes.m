%% File Load Buffer
Directory = '/Users/barabasi/Dropbox/Shared_Folders/Brain-Determistic-Dani/Code/CElegansOld/CElegansOldRands/';
ChemAnalyzedName = 'CEO_Chem_RandBC';
GapAnalyzedName = 'CEO_Gap_RandBC';
...
A = fopen('/Users/barabasi/Dropbox/Shared_Folders/Brain-Determistic-Dani/Code/CElegansOld/CEO_Chem_BCs.txt');
...
%%
Zs = (BioGap_SizesMat-mean(RandGap_SizesMat,3))./std(RandGap_SizesMat,0,3);
ZCols = Zs;
ZCols(Zs>2) = 2;
ZCols(Zs<-2) = 0;
